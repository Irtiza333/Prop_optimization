...
for case in cases:
    if case not in failed_cases:
        ...
        res_dir = work_dir / f"sample{case}_001.res"
        ...
        csv_path3 = Path(f"/home/irtiza/scratch/mesh/infill1/export1600_{case}.csv")
